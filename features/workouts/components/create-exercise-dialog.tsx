                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            {watchedBodyRegion ? (
                                                <Tabs value={field.value || ''} onValueChange={field.onChange}>
                                                    <TabsList className={`grid w-full h-auto ${watchedBodyRegion === 'LOWER' ? 'grid-cols-2' : 'grid-cols-3'}`}>
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Tabs value={field.value || ''} onValueChange={field.onChange}>
                                            <TabsList className="grid w-full grid-cols-3">
                                                <TabsTrigger value="Beginner" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Beginner</TabsTrigger>
                                                <TabsTrigger value="Intermediate" className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground">Intermediate</TabsTrigger>
