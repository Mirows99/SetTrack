...
const workoutOptions: Record<WorkoutOptionType, WorkoutOption> = {
  [WorkoutOptionType.QUICK_START]: {
    icon: PlayCircle,
    title: "Quick Start",
    description: "Start tracking a workout right away without any template. Build your workout as you go.",
  ...
  [WorkoutOptionType.USE_TEMPLATE]: {
    icon: Clipboard,
    title: "Use Template", 
    description: "Choose from your saved workout templates or create a new one to use for your session.",
  ...
  [WorkoutOptionType.GENERATE_WORKOUT]: {
    ...
    description: "Let us build a personalized workout for you based on your goals and available equipment.",
