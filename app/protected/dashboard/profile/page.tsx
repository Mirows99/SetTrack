        ...
        <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="border rounded-lg p-3">
                    ...
                    <div className="text-xs text-green-500 mt-1">↑ 2.5 kg this month</div>
                  </div>
                  <div className="border rounded-lg p-3">
                    <div className="text-sm font-medium text-muted-foreground">Body Fat %</div>
                  ...
                  <div className="border rounded-lg p-3">
                    ...
                    <div className="text-xs text-green-500 mt-1">↑ 1.5 kg this month</div>
                  </div>
                  <div className="border rounded-lg p-3">
                    <div className="text-sm font-medium text-muted-foreground">BMI</div>
                    <div className="text-2xl font-bold mt-1">23.1</div>
                    <div className="text-xs text-green-500 mt-1">Within normal range</div>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set and track your training objectives</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="border rounded-lg p-4">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">Target: December 2023</div>
                </div>
                <div className="border rounded-lg p-4">
                  <div className="flex justify-between items-center">
                  ...
                  <div className="text-xs text-muted-foreground mt-1">Target: November 2023</div>
                </div>
                <div className="border rounded-lg p-4">
                  <div className="flex justify-between items-center">
                    <div className="font-medium">Increase Flexibility</div>
                    <div className="text-sm text-muted-foreground">Just Started</div>
                  </div>
                  <div className="w-full bg-muted rounded-full h-2 mt-2">
                    <div className="bg-primary rounded-full h-2 w-[15%]"></div>
                  </div>
                  <div className="text-xs text-muted-foreground mt-1">Target: January 2024</div>
                </div>
              </div>
            </CardContent>
          </Card>
